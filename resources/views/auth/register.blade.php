<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <button type="submit" class="ms-4 inline-flex items-center justify-center px-5 py-2.5 border-2 border-yellow-500 text-indigo-800 bg-yellow-50 rounded-lg hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition font-bold text-sm">
