...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)"
     ...
     class="fixed top-20 start-1/2 -translate-x-1/2 z-50 min-w-[320px]">
    ...
    <div class="bg-green-50 border border-green-300 text-green-800 rounded-lg px-5 py-3 shadow-lg flex items-center gap-3">
        ...
        <button @click="show = false" class="me-auto text-green-500 hover:text-green-700">&times;</button>
    </div>
    @endif
    ...
    <div class="bg-red-50 border border-red-300 text-red-800 rounded-lg px-5 py-3 shadow-lg flex items-center gap-3">
        ...
        <button @click="show = false" class="me-auto text-red-500 hover:text-red-700">&times;</button>
    </div>
    @endif
    ...
    <div class="bg-yellow-50 border border-yellow-300 text-yellow-800 rounded-lg px-5 py-3 shadow-lg flex items-center gap-3">
        ...
        <button @click="show = false" class="me-auto text-yellow-500 hover:text-yellow-700">&times;</button>
    </div>
    @endif
</div>
@endif
